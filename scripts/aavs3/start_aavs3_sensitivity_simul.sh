...
if [[ ! -s antenna_locations_aavs3.txt ]]; then
   echo "cp ~/aavs-calibration/config/aavs3/antenna_locations.txt antenna_locations_aavs3.txt"
   cp ~/aavs-calibration/config/aavs3/antenna_locations.txt antenna_locations_aavs3.txt
else
