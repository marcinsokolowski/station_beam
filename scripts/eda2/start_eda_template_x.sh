...
nohup simulate_total_power_vs_time_date_range.sh $start_date $n_days $time_step /raid/data/eda/eda2/simulations /raid/data/eda/eda2/simulations/AntennaPatterns/EDA2_256/EDA2_256_elem_station_${freq}MHz_Xpol.txt.DONT_DO /home/bighorns/bighorns/software/analysis/scripts/shell/eda/eda2/config/antenna_locations_eda2.txt $parallel ${freq} - - ${pointing_az_deg} ${pointing_za_deg} > out 2>&1 &
