...
urlpatterns = [
    ...
    path('posts/', sensitivity_radec_vs_lst.urls),
    path('posts/', sensitivity_radec_vs_lst_show.urls),
    path('posts/', sensitivity_radec_astro.urls),
    path('posts/', sensitivity_radec_astro_show.urls),
